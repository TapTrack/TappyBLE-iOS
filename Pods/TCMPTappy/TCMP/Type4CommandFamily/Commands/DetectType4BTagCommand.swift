...
@objc public class DetectType4BTagCommand: NSObject, TCMPMessage {
    
    @objc public let commandFamily: [UInt8] = CommandFamily.type4
    
    @objc public let commandCode: UInt8 = Type4CommandCode.detectType4BTag.rawValue
