//
//  Ntag21xApplicationErrorResponse.swift
//  TappyBLE
//
...
@objc public class Ntag21xApplicationErrorResponse: NSObject, TCMPMessage, TCMPApplicationErrorMessage {
    
    @objc public let commandFamily: [UInt8] = CommandFamily.ntag21x
    
    @objc public private(set) var commandCode: UInt8 = Ntag21xResponseCode.error.rawValue
